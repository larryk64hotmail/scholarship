...
<cfif isdefined("form.password")>
	...
	<cfinvoke method="insert_users" component="cfc.company"  >
      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase" style="min-width: 280px;">
            	<span>Company</span><strong class="text-primary"> Registration</strong>
            </div>
            
            <form class="text-left form-validate" action="" method="post" >
	        <cfif isdefined("url.duplicate")>
	        <div class="alert alert-success" role="alert">
				Account Already exists.<br><a href="login.cfm">Please Login</a>
			</div>
			</cfif>
            	
              <div class="form-group-material">
                <input id="register-companyname" type="text" name="CompanyName" required data-msg="Please enter your company or foundation name" class="input-material">
                <label for="register-companyname" class="label-material">Company or Foundation Name</label>
              </div>
              <div class="form-group-material">
            ...
            </form><small>Already have an account? </small><a href="login.cfm" class="signup">Login</a>
