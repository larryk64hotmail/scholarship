...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/4.4.5/js/locales/LANG.js"></script>
		...
		<cfoutput >
		<cfif getScholarshipInfo.heroImage is "">
			<cfset thisheroimage = "header.jpg">
		<cfelse>	
			<cfset thisheroimage = "#getScholarshipInfo.heroImage#">
		</cfif>	
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="scholarship/img/hero/#thisheroimage#">
              <img class="img-fluid" src="scholarship/img/hero/#thisheroimage#" alt="">
	...
	$("#input-id").fileinput({'showUpload':false, 'previewFileType':'any'}); 		
  	...
  	<input id="input-id" name="heroImage" type="file" class="file" data-preview-file-type="text">
